...
public class ReviewController {
    ...
    public ResponseEntity<ReviewResponse> getReviewById(
        ...
        ReviewResponse reviewResponse = reviewFacade.getReviewById(userId, reviewId);
    ...
    public ResponseEntity<ReviewResponse> updateReviewById(
        ...
        ReviewResponse reviewResponse = reviewFacade.updateReview(userId, reviewId, updateReviewRequest);
        return ResponseEntity.ok(reviewResponse);
    }
